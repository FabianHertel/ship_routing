...
impl BinaryMinHeap {
    ...
    fn reheap<T: std::cmp::PartialOrd>(&mut self, index: usize, priorities: &Vec<T>) {
    ...
    pub fn push<T: std::cmp::PartialOrd>(&mut self, key: usize, priorities: &Vec<T>) {
        self.heap.push(key);
    ...
    pub fn pop<T: std::cmp::PartialOrd>(&mut self, priorities: &Vec<T>) -> usize {
    ...
    pub fn decrease_key<T: std::cmp::PartialOrd>(&mut self, key: usize, priorities: &Vec<T>) {
    ...
    pub fn insert_or_update<T: std::cmp::PartialOrd>(&mut self, key: usize, priorities: &Vec<T>) {
